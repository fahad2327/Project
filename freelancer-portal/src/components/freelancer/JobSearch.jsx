        ...
        <div className="job-search-container">
            ...
            {showFilters && (
                <div className="filters-panel">
                    <div className="filters-header">
                        <h3>Filter Jobs</h3>
                        <button type="button" onClick={clearFilters} className="clear-filters">Clear All</button>
                    </div>
                    <div className="filters-grid">
                        <div className="filter-group">
                            <label>Experience Level</label>
                        ...
                        <div className="filter-group">
                            <label>Minimum Pay ($/hr)</label>
                            <input type="number" name="min_pay" value={filters.min_pay} onChange={handleFilterChange}
                                placeholder="e.g., 30" min="0" />
                        </div>
                        <div className="filter-group">
                            <label>Maximum Pay ($/hr)</label>
                            <input type="number" name="max_pay" value={filters.max_pay} onChange={handleFilterChange}
                                placeholder="e.g., 100" min="0" />
                        </div>
                        <div className="filter-group checkbox">
                            <label className="checkbox-label">
                                <input type="checkbox" name="is_remote" checked={filters.is_remote} onChange={handleFilterChange} />
                                <span>Remote Only</span>
                            </label>
                        </div>
                    </div>
                    <div className="filters-actions">
                        <button onClick={searchJobs} className="btn btn-primary">Apply Filters</button>
                    </div>
                </div>
            )}
                    ...
                    <div className="jobs-grid">
                        {jobs.map(job => (
                            <div key={job.id} className="job-card">
                                ...
                                <div className="job-details">
                                    <div className="job-detail"><i className="fas fa-dollar-sign"></i><span>${job.pay_per_hour}/hr</span></div>
                                    <div className="job-detail"><i className="fas fa-briefcase"></i><span>{job.experience_level}</span></div>
                                    <div className="job-detail"><i className="fas fa-clock"></i><span>{job.job_type}</span></div>
                                    {job.is_remote && (
                                        <div className="job-detail remote"><i className="fas fa-globe"></i><span>Remote</span></div>
                                    )}
                                </div>
                                ...
                                <div className="job-card-footer">
                                    <span className="posted-date">Posted {new Date(job.created_at).toLocaleDateString()}</span>
                                    <Link to={`/jobs/${job.id}`} className="btn btn-primary btn-small">View Details</Link>
                                </div>
                            </div>
                        ))}
                    </div>
