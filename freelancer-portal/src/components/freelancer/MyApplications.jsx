                ...
                <div className="applications-grid">
                    {applications.map((app) => (
                        <div key={app.id} className="application-card">
                            ...
                            <p className="company-name">{app.company_name}</p>
                            <div className="application-details">
                                <div className="detail"><i className="fas fa-dollar-sign"></i><span>${app.pay_per_hour}/hr</span></div>
                                <div className="detail"><i className="fas fa-calendar"></i><span>Applied: {new Date(app.applied_at).toLocaleDateString()}</span></div>
                            </div>
                            {app.recruiter_notes && (
                                <div className="recruiter-notes">
                                    <strong>Recruiter Notes:</strong>
                            ...
                            <div className="application-footer">
                                <Link to={`/jobs/${app.job_id}`} className="btn btn-outline btn-small">View Job</Link>
                            </div>
                        </div>
                    ))}
                </div>
