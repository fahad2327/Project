    ...
    return (
        <div className="freelancer-dashboard">
            ...
            <div className="welcome-section">
                ...
                <div className="profile-completion">
                    <div className="completion-circle">
                        ...
                        <span className="completion-percentage">{stats?.profile_completion || 0}%</span>
                    </div>
                    <div className="completion-text">
                        <h3>Profile Strength</h3>
                        <Link to="/profile" className="btn btn-outline btn-small">Complete Profile</Link>
                    </div>
                </div>
            </div>
            ...
            <div className="stats-grid">
                ...
                <div className="stat-card">
                    <div className="stat-icon rate"><i className="fas fa-dollar-sign"></i></div>
                    <div className="stat-details">
                        <h3>${profile?.hourly_rate || 0}</h3>
                        <p>Hourly Rate</p>
                    </div>
            ...
            <div className="dashboard-grid">
                ...
                <div className="dashboard-card recent-applications">
                    <div className="card-header">
                        ...
                        <Link to="/my-applications" className="view-all">View All</Link>
                    </div>
                    <div className="applications-list">
                        {recent_applications?.length > 0 ? (
                            recent_applications.map((app) => (
                                ...
                                <div key={job.id} className="job-item">
                                    <div className="job-info">
                                        ...
                                        <div className="job-meta">
                                            ...
                                            <span><i className="fas fa-briefcase"></i> {job.experience_level}</span>
                                            {job.is_remote && (
                                                <span className="remote-badge"><i className="fas fa-globe"></i> Remote</span>
                                            )}
                                        </div>
                                    </div>
                                    <Link to={`/jobs/${job.id}`} className="btn btn-outline btn-small">View Job</Link>
                                </div>
                            ))
                        ) : (
                            <div className="empty-state">
                ...
                <div className="dashboard-card skills-section">
                    <div className="card-header">
                        ...
                        <Link to="/profile" className="edit-link"><i className="fas fa-edit"></i> Edit</Link>
                    </div>
                    <div className="skills-container">
                        {profile?.skills?.length > 0 ? (
                            profile.skills.map((skill) => (
                                <span key={skill.id} className="skill-tag">
                                    {skill.name}
                                    {skill.proficiency_level && <span className="proficiency">{skill.proficiency_level}</span>}
                                </span>
                            ))
                        ) : (
                            <div className="empty-state">
                                <p>No skills added yet</p>
                                <Link to="/profile" className="btn btn-outline btn-small">Add Skills</Link>
                            </div>
                        )}
                    </div>
                    {profile?.tech_stacks?.length > 0 && (
                        <>
                            ...
                            <div className="tech-stack-container">
                                {profile.tech_stacks.map((tech) => (
                                    <span key={tech.id} className="tech-tag">
                                        {tech.name}
                                        {tech.experience_years && <span className="experience">{tech.experience_years}y</span>}
                                    </span>
                                ))}
                            </div>
                        </>
