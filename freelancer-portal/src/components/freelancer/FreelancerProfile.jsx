            ...
            <form onSubmit={handleSubmit} className="profile-form">
                ...
                <div className="form-section">
                    ...
                    <div className="form-row">
                        <div className="form-group">
                            <label>First Name</label>
                            <input type="text" value={user?.first_name || ''} disabled className="disabled" />
                        </div>
                        <div className="form-group">
                            <label>Last Name</label>
                            <input type="text" value={user?.last_name || ''} disabled className="disabled" />
                        </div>
                    </div>
                    <div className="form-group">
                        <label>Email</label>
                ...
                <div className="form-section">
                    ...
                    <div className="form-row">
                        <div className="form-group">
                            <label htmlFor="hourly_rate">Hourly Rate ($)</label>
                            <input type="number" id="hourly_rate" name="hourly_rate" value={profile.hourly_rate || ''}
                                onChange={handleChange} placeholder="e.g., 50" min="0" step="0.01" />
                        </div>
                        <div className="form-group">
                            <label htmlFor="years_of_experience">Years of Experience</label>
                            <input type="number" id="years_of_experience" name="years_of_experience"
                                value={profile.years_of_experience || ''} onChange={handleChange} placeholder="e.g., 5" min="0" />
                        </div>
                    </div>
                    <div className="form-group">
                        <label htmlFor="education">Education</label>
                        <textarea id="education" name="education" rows="3" value={profile.education || ''} onChange={handleChange}
                            placeholder="e.g., B.Tech Computer Science, XYZ University, 2020" />
                    </div>
                    <div className="form-group">
                        <label htmlFor="experience">Work Experience</label>
                ...
                <div className="form-section">
                    ...
                    <div className="skills-container">
                        {profile.skills?.map((skill) => (
                            <span key={skill.id || skill.name} className="skill-tag">
                                {skill.name}
                                <button type="button" onClick={() => handleRemoveSkill(skill.name)} className="remove-tag">×</button>
                            </span>
                        ))}
                    </div>
                </div>
                ...
                <div className="form-section">
                    ...
                    <div className="tech-stack-container">
                        {profile.tech_stacks?.map((tech) => (
                            <span key={tech.id || tech.name} className="tech-tag">
                                {tech.name}
                                <button type="button" onClick={() => handleRemoveTech(tech.name)} className="remove-tag">×</button>
                            </span>
                        ))}
                    </div>
                </div>
                ...
                <div className="form-section">
                    ...
                    <div className="form-group">
                        <label htmlFor="github_url">GitHub URL</label>
                        <input type="url" id="github_url" name="github_url" value={profile.github_url || ''} onChange={handleChange}
                            placeholder="https://github.com/username" />
                    </div>
                    <div className="form-group">
                        <label htmlFor="linkedin_url">LinkedIn URL</label>
                        <input type="url" id="linkedin_url" name="linkedin_url" value={profile.linkedin_url || ''} onChange={handleChange}
                            placeholder="https://linkedin.com/in/username" />
                    </div>
                    <div className="form-group">
                        <label htmlFor="portfolio_url">Portfolio URL</label>
                        <input type="url" id="portfolio_url" name="portfolio_url" value={profile.portfolio_url || ''} onChange={handleChange}
                            placeholder="https://yourportfolio.com" />
                    </div>
                </div>
                ...
                <div className="form-section">
                    <h2>Availability</h2>
                    <label className="checkbox-label">
                        <input type="checkbox" name="is_available" checked={profile.is_available} onChange={handleChange} />
                        <span>Available for work</span>
                    </label>
                </div>
