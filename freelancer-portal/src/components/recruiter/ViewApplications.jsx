...
//                     <h3>No applications yet</h3>
//                     <p>When freelancers apply for this job, they will appear here.</p>
//                     <button onClick={() => navigate('/manage-jobs')} className="btn btn-outline">Back to Jobs</button>
//                 </div>
//             ) : (
//                 <div className="applications-grid">
//                     {applications.map((app) => (
//                         <div key={app.id} className="application-card">
//                             <div className="applicant-header">
//                                 <div className="applicant-avatar" style={{ backgroundColor: '#2563eb' }}>
//                                     {app.freelancer_name?.charAt(0)}
//                                 </div>
//                                 <div className="applicant-info">
//                                     <h3>{app.freelancer_name}</h3>
...
//                                 </div>
//                                 <div className="detail-row">
//                                     <span className="detail-label"><i className="fas fa-calendar"></i> Availability:</span>
//                                     <span className="detail-value">{app.availability_date ? new Date(app.availability_date).toLocaleDateString() : 'Immediate'}</span>
//                                 </div>
//                                 <div className="detail-row">
//                                     <span className="detail-label"><i className="fas fa-clock"></i> Applied:</span>
...
//                                 <div className="status-update-form">
//                                     <h4>Update Application Status</h4>
//                                     <select value={statusUpdate} onChange={(e) => setStatusUpdate(e.target.value)} className="status-select">
//                                         <option value="">Select Status</option>
//                                         <option value="reviewed">Mark as Reviewed</option>
//                                         <option value="shortlisted">Shortlist</option>
//                                         <option value="accepted">Accept</option>
...
//                                     <div className="form-actions">
//                                         <button onClick={() => handleStatusUpdate(app.id)} className="btn btn-primary">Update Status</button>
//                                         <button onClick={() => setSelectedApplication(null)} className="btn btn-outline">Cancel</button>
//                                     </div>
//                                 </div>
//                             ) : (
//                                 <div className="application-actions">
//                                     <button onClick={() => setSelectedApplication(app.id)} className="btn btn-primary">Update Status</button>
//                                     <button className="btn btn-outline"><i className="fas fa-download"></i> Resume</button>
//                                 </div>
//                             )}
//                         </div>
//                     ))}
        ...
        <div className="view-applications-container">
            <div className="applications-header">
                ...
                <div className="applications-stats">
                    ...
                    <div className="stat">
                        {/* <span className="stat-value">{applications.filter(a => a.status === 'pending').length}</span> */}
                        <span className="stat-value">{applications.filter(a => !['shortlisted', 'accepted', 'rejected'].includes(a.status)).length}</span>
                        <span className="stat-label">Pending</span>
                    </div>
                    <div className="stat">
                        <span className="stat-value">{applications.filter(a => a.status === 'shortlisted').length}</span>
