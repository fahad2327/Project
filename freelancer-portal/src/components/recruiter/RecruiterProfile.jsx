        ...
        <div className="profile-container">
            ...
            <form onSubmit={handleSubmit} className="profile-form">
                <div className="form-section">
                    ...
                    <div className="form-group">
                        <label>Company Name</label>
                        <input type="text" name="company_name" value={profile.company_name || ''} onChange={handleChange} required />
                    </div>

                    <div className="form-group">
                        <label>Company Website</label>
                        <input type="url" name="company_website" value={profile.company_website || ''} onChange={handleChange}
                            placeholder="https://example.com" />
                    </div>
                    ...
                    <div className="form-group">
                        ...
                        <textarea name="company_description" value={profile.company_description || ''} onChange={handleChange}
                            rows="5" placeholder="Tell freelancers about your company..." />
                    </div>
